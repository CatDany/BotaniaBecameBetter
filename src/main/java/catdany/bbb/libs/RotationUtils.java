...
public class RotationUtils
{
	...
	public static RotationLiving getRotationFromLiving(EntityLivingBase living)
	{
		return new RotationLiving(living.posX, living.posY, living.posZ, living.rotationPitch, living.rotationYaw, living.rotationYawHead);
	}
	...
	public static class Position
	{
		...
		public boolean equals(Object obj)
		{
			...
			return this.positionX == p.positionX && this.positionY == p.positionY && this.positionZ == p.positionZ;
		}
	}
	
	public static class Rotation extends Position
	{
		...
		public boolean equals(Object obj)
		{
			...
			return super.equals(obj) && this.rotationPitch == r.rotationPitch && this.rotationYaw == r.rotationYaw;
		}
	}
	
	public static class RotationLiving extends Rotation
	{
		public float rotationYawHead;
		
		public RotationLiving(double x, double y, double z, float pitch, float yaw, float yawHead)
		{
		...
		public boolean equals(Object obj)
		{
			RotationLiving r = (RotationLiving)obj;
			return super.equals(obj) && this.rotationYawHead == r.rotationYawHead;
		}
	}
